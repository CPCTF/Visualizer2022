...
`,ci=i=>new re({uniforms:{colorA:{value:i},time:{value:0}},fragmentShader:ni,vertexShader:ri,transparent:!0}),li=i=>new re({uniforms:{colorA:{value:i},time:{value:0}},fragmentShader:ai,vertexShader:oi,transparent:!0,side:Pt}),Ie=(i,e)=>{const t=i.geometry;t.clearGroups(),t.addGroup(0,1/0,0),t.addGroup(0,1/0,1),i.material=[ci(e),li(e)]},te=class extends B{constructor(e=0){super();d(this,"emergencyBlack");d(this,"emergencyRed");d(this,"offsetTime");d(this,"loopTime",2);var t,s;if(te.emergencyBlackGeom==null){const r=(t=A.get($e))==null?void 0:t.clone();te.emergencyBlackGeom=r.children[0].geometry}if(te.emergencyRedGeom==null){const r=(s=A.get($e))==null?void 0:s.clone();te.emergencyRedGeom=r.children[1].geometry}this.offsetTime=e,this.emergencyBlack=new ge(te.emergencyBlackGeom),this.emergencyRed=new ge(te.emergencyRedGeom),Ie(this.emergencyBlack,new E(0)),Ie(this.emergencyRed,new E(16711680)),this.add(this.emergencyBlack),this.add(this.emergencyRed)}start(){super.start()}update(){super.update();let e=Math.sin((y.time+this.offsetTime)/this.loopTime*Math.PI*2);e=e<0?0:e,this.scale.set(e,e,e),this.emergencyBlack.material[0].uniforms.time.value=y.time+this.offsetTime,this.emergencyRed.material[0].uniforms.time.value=y.time+this.offsetTime,this.emergencyBlack.material[1].uniforms.time.value=y.time+this.offsetTime,this.emergencyRed.material[1].uniforms.time.value=y.time+this.offsetTime}};let Pe=te;d(Pe,"emergencyBlackGeom"),d(Pe,"emergencyRedGeom");class ui extends B{constructor(){super();d(this,"size",30);d(this,"positionOffset",2/Math.sqrt(3));d(this,"offsetTimeUnit",.1);d(this,"emergencies",new Array(0));for(let e=0;e<this.size;e++){const t=e*(this.positionOffset*3/2)-Math.floor(this.size/2),s=e*this.offsetTimeUnit;for(let r=0;r<this.size;r++){const n=r*(Math.sqrt(3)*this.positionOffset)+(e%2==1?this.positionOffset*(Math.sqrt(3)/2):0)-Math.floor(this.size/2),o=new Pe(s);o.position.setX(n),o.position.setZ(t),this.emergencies.push(o),this.add(o)}}}}class Ht extends J{constructor(e){const t=e.clipBias!==void 0?e.clipBias:0,s=e.alpha!==void 0?e.alpha:1,r=e.time!==void 0?e.time:0,n=e.waterNormals!==void 0?e.waterNormals:null,o=e.sunDirection!==void 0?e.sunDirection:new L(.70707,.70707,0),a=new E(e.sunColor!==void 0?e.sunColor:16777215),c=new E(e.waterColor!==void 0?e.waterColor:8355711),u=e.eye!==void 0?e.eye:new L(0,0,0),f=e.distortionScale!==void 0?e.distortionScale:20,p=e.side!==void 0?e.side:Mt,m=e.fog!==void 0?e.fog:!1,z=new qt,I=new L,G=new L,Z=new L,g=new Be,C=new L(0,0,-1),w=new ut,Q=new L,K=new L,ne=new ut,ae=new Be,U=new zt,he={uniforms:dt.merge([ht.fog,ht.lights,{normalSampler:{value:null},mirrorSampler:{value:null},alpha:{value:1},time:{value:0},size:{value:1},distortionScale:{value:20},textureMatrix:{value:new Be},sunColor:{value:new E(8355711)},sunDirection:{value:new L(.70707,.70707,0)},eye:{value:new L},waterColor:{value:new E(5592405)}}]),vertexShader:`
